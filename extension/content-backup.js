(function() {
    ...
    function getFEN() {
        ...
        if (window.chessboard && window.chessboard.getFEN) {
            const fen = window.chessboard.getFEN();
            return fen;
        }
        ...
        try {
            for (let key in window) {
                try {
                    if (window[key] && typeof window[key].getFEN === 'function') {
                        const fen = window[key].getFEN();
                        return fen;
                    }
                } catch (e) {
        ...
        try {
            ...
            if (board) {
                ...
                if (board.state && board.state.fen) {
                    return board.state.fen;
                }
